    ...
    with dpg.window(label="Mestre", width=1000, no_close=True, pos=(0, 20)):
        with dpg.tab_bar(label="MenuMaster"):
            with dpg.tab(label="Geral"):
                ...
                dpg.add_spacer()
                with dpg.group():
                    dpg.add_text("Atenção! Na aba dos NPCs há um elemento que não está presente no\nlivro. A Dificuldade é a soma dos atributos do NPC. Se preferir\ncoloque da seguinte maneira: (10)(9)(8)(11)(12)", color=(255, 0, 0))
